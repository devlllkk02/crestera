...
import slideicon from '../../../assets/images/Vault icons/FileIcon.png';
    ...
    <div className="boardshare">
        ...
        <div className="boardshare_details">
            <div className="boardshare_icon">
                <img src={slideicon} alt="icon"/>
            </div>
            <div className="boardshare_details_list">
                <div className="boardshare_details_name">
                <p1>Name :</p1>&nbsp;
                <p2>Board 01</p2>
            </div>
            <div className="boardshare_details_type">
                <p1>Type :</p1>&nbsp;
                <p2>png</p2>
            </div>
            <div className="boardshare_details_size">
                <p1>Size:</p1>&nbsp;
                <p2>11.5 MB</p2>
            </div>
        ...
        <div className="boardshare_download">
            ...
            <div className="boardshare_download_body">
                <div className="boardshare__filetype">
                    <p>File Type</p>
                </div>
